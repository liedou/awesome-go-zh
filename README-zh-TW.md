...
- [Awesome Go (正體中文版)](#Awesome-Go-(正體中文版))
  - [目錄](#目錄)
  - [人工智慧](#人工智慧)
  - [音訊處理](#音訊處理)
...
- [langchaingo](https://github.com/tmc/langchaingo) - LangChainGo 是一個用於開發語言模型程式的框架。
- [LocalAI](https://github.com/mudler/LocalAI) - OpenAI 的開源替代品，可託管 AI 模型。
- [Ollama](https://github.com/jmorganca/ollama) - 可在本地運行大語言模型。
...
- [flac](https://github.com/mewkiz/flac) - 提供 Go 原生支援的 FLAC 串流編解碼器。
- [gaad](https://github.com/Comcast/gaad) - 提供 Go 原生支援的 AAC 比特流解析器。
- [GoAudio](https://github.com/DylanMeeus/GoAudio) - 一个 Go 原生支援的音訊處理庫。
- [gosamplerate](https://github.com/dh1tw/gosamplerate) - libsamplerate 庫的 Go 實現。
- [id3v2](https://github.com/bogem/id3v2) - 一个 ID3 的編解碼庫。
- [malgo](https://github.com/gen2brain/malgo) - 一个小型的音訊庫。
- [minimp3](https://github.com/tosone/minimp3) - 一个輕量級的 MP3 解碼庫。
- [Oto](https://github.com/hajimehoshi/oto) - 一个可跨平臺播放音樂的庫。
- [PortAudio](https://github.com/gordonklaus/portaudio) - PortAudio 音訊庫的 Go 實現.
